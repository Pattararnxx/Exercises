...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('theme-toggle-light').onclick = () => setThemeMode('light');
    document.getElementById('theme-toggle-dark').onclick = () => setThemeMode('dark');
    document.getElementById('theme-toggle-system').onclick = () => setThemeMode('system');
});
...
function createPokemonCard(pokemonDetails) {
    ...
    card.innerHTML = `
      ...
      <div class="z-10 w-[50%] flex justify-center items-center">
        <img loading="lazy" src="${pokemonDetails.sprites.other['official-artwork'].front_default}" alt="" class="w-full h-auto max-h-[150px] sm:max-h-[200px] md:max-h-[300px] object-contain" />
      </div>
...
function showPokemonDetails(pokemonDetails) {
    ...
    <div class="relative z-60 ${bgColor} w-full h-auto overflow-hidden">
        <div class="flex flex-col justify-center items-center text-center py-4">
            ...
            <div class="z-10 w-[50%] flex justify-center items-center">
            <img loading="lazy" src="${pokemonDetails.sprites.other['official-artwork'].front_default}" 
                alt="" 
        ...
        <div class="flex flex-col justify-items-start items-start p-5 sm:p-10 rounded-t-[30px] sm:rounded-[50px] bg-white  shadow-[0_10px_30px_rgba(0,0,0,0.6)]">
...
function showAboutTab(pokemonDetails, tabContent) {
    tabContent.innerHTML = `
       <div class="flex flex-col sm:flex-row sm:gap-30">
            ...
            <div class="font-bold text-black ">${pokemonDetails.types.map(t=> `
       ...
       <div class="flex flex-col sm:flex-row sm:gap-32">
            ...
            <div class="font-bold text-black e">${pokemonDetails.height}<span>0cm</span></div>
       </div>
       <div class="flex flex-col sm:flex-row sm:gap-32">
            <h2 class="text-gray-700 w-24 sm:w-auto">Weight</h2>
            <div class="font-bold text-black ">${pokemonDetails.weight/10} <span>kg</span></div>
       </div>
       <div class="flex flex-col sm:flex-row sm:gap-30">
            <h2 class="text-gray-700 w-24 sm:w-auto">Abilities</h2>
            <div class="font-bold text-black ">${pokemonDetails.abilities.map(a=> `
